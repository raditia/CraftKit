...
3. **If found:** read it — use it as your understanding of what's being worked on. The "Test Coverage Needed" section tells you exactly what to target. Skip re-scanning the project.
