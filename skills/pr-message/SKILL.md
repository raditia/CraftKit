...
> Triggered by: "generate PR message", "write PR description", "create pull request message", "draft PR", "PR message for this branch"
...
- Test coverage section: if no test files changed, always flag it explicitly
